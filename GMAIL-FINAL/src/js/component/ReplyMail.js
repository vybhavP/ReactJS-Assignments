...
submit:function(){
  ...
  $.ajax({
         url: 'https://www.googleapis.com/gmail/v1/users/podalavybhav%40gmail.com/messages/send?key={AIzaSyDQ25IjOBgw2UYXQpSFTmLDtsJrwx_lukk}',
         dataType: 'json',
...
<div className="modal fade" id="ReplyMail">
    ...
    <form  className="form-horizontal">
      <div className="form-group">
        <div className="col-lg-12">
          <input className="form-control"   id="To" type="email" value={this.props.reFrom} onChange={this.sending} />
        </div>
      </div>
      <div className="form-group">
        <div className="col-lg-12">
          <input className="form-control" id="Subject"   type="text"value={this.props.reSubject} onChange={this.sending} />
        </div>
      </div>
      <div className="form-group">
        <div className="col-lg-12" >
