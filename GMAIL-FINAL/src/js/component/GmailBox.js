...
var GmailBox = React.createClass({
 ...
 gmailLogin: function() //function for gmailLogin Authorization
 {
   ...
   var TYPE        =   'token';//every time it generates one token
...
getmsgIDS: function(mID)
  {
    var accessToken = localStorage.getItem('gToken');
    $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/podalavybhav%40gmail.com/messages?labelIds='+mID+'&maxResults=10&key={AIzaSyDQ25IjOBgw2UYXQpSFTmLDtsJrwx_lukk}',
      dataType: 'json',
      type: 'GET',
      async:false,
